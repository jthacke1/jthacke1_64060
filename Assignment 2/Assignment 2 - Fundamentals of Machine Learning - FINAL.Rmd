...
nn
```
Performed k-NN classification with default cutoff value of 0.5 and a success class of 1. This customer would be accepted for a personal loan.
```{r}
...
accuracy.df shows the accuracy of each K value with 1 being the most accurate with an accuracy of 1.0.
```{r}
...
```{r}
nn2<-knn(train=train.norm.df[,c(1:6,8:14)],test=customer2.df,cl=train.norm.df[,7],k=1,prob=TRUE)
nn2
```
